...
//             <h2 className="text-xl font-bold">Job Sarthi</h2>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-left mb-6 md:mb-0">
            <h2 className="text-2xl font-bold text-gray-800">Job Sarthi</h2>
            <p className="text-sm text-gray-600 mt-1">© 2024 Job Sarthi. All rights reserved.</p>
          </div>
